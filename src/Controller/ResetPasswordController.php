...
{
    // Here we use symfonycasts/reset-password-bundle (https://github.com/SymfonyCasts/reset-password-bundle)
     ...
     *
     * @Route("/verification-email", name="check-email")
     */
     ...
     *
     * @Route("/reinitialiser/{token}", name="reset-password")
     */
    public function reset(Request $request, UserPasswordHasherInterface $hasher, string $token = null): Response
    {
        ...
        try {
            ...
            $this->addFlash('danger', sprintf(
                "Un problème s'est produit lors de votre demande de réinitialisation de mot de passe : %s",
                $e->getReason()
            ));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', "Votre mot de passe à bien été modifié, merci de vous reconnecter");
